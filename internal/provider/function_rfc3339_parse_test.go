		...
		Steps: []resource.TestStep{
			{
				Config: `
                output "test" {
                    value = provider::tfproj::rfc3339_parse("2023-07-25T23:43:16Z")
                }
                `,
			...
			},
			{
				Config: `
                output "test" {
                    value = provider::tfproj::rfc3339_parse("2023-07-25T23:43:16-00:00")
                }
                `,
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
		...
		Steps: []resource.TestStep{
			{
				Config: `
                output "test" {
                    value = provider::tfproj::rfc3339_parse("1996-12-19T16:39:57-08:00")
                }
                `,
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
		...
		Steps: []resource.TestStep{
			{
				Config: `
                output "test" {
                    value = provider::tfproj::rfc3339_parse("abcdef")
                }
                `,
